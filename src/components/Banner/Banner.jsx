...
import bannerBg from "../../assets/images/ban.png";
      ...
      <div className="max-w-[1440px] mx-auto">
        ...
        >
          <div className="flex flex-col py-8 px-16 text-white gap-5 bg-[#ffafcf] max-w-[460px] rounded-r-full">
            <span style={{textShadow: "2px 2px 2px #000000"}} className="md:text-xl font-bold">OUR EXCLUSIVE</span>
            ...
            <span style={{textShadow: "2px 2px 1px #000000"}} className="md:text-2xl">
